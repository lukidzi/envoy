...
public:
  ...
  LocalReply::LocalReplyPtr local_reply_ = std::make_unique<LocalReply::LocalReply>(LocalReply::LocalReply{
      {}, std::make_unique<Envoy::AccessLog::FormatterImpl>("%RESP_BODY%"), Http::Headers::get().ContentTypeValues.Text});
};
